...
\begin{figure}
	...
	\caption[asdf]{
		A diagram of the four packets involved in an injection of the file \texttt{http://adnetpub.yaolan.com/js/adpubs.js}.
		\begin{enumerate}\addtolength{\itemsep}{-.35\baselineskip}\footnotesize{}
			...
			\item TTLProbe requests the file \texttt{http://adnetpub.yaolan.com/js/adpubs.js} from \texttt{http://adnetpub.yaolan.com} through Router.
